...
#body{
	background-image: url(/wp-content/themes/gwt-wordpress-27.0.0/images/labo.jpg);
...
?>
	 ...
	 */
		...
		$login_header_url = __(WP_SITEURL);
	...
	<body id="body" class="login no-js <?php echo esc_attr(implode(' ', $classes)); ?>">
		<div id="overlays"></div>
		<div id="contents">
			<?php
		...
		<div id="login">
			<style>
				#logos {
					background-image: url(/wp-content/themes/gwt-wordpress-27.0.0/images/lgu_icon.png);
			...
			<h2 role="presentation" class="wp-login-logo"><a id="logos" href="<?php echo esc_url($login_header_url); ?>"><?php echo $login_header_text; ?></a></h2>
			<?php
			/**
 ...
 */
	...
	?>
		...
		<form name="loginform" id="loginform" action="<?php echo esc_url(site_url('wp-login.php', 'login_post')); ?>" method="post">
			...
			?>
			<p class="forgetmenot" id="remember"><input name="rememberme" type="checkbox" id="rememberme" value="forever" <?php checked($rememberme); ?> /> <label for="rememberme"><?php esc_html_e('Remember Me'); ?></label></p>
			<p class="submit">
